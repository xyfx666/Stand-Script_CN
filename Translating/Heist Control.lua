...
--- Cayo Secondary
    ...
    menu.action(CAYO_SECONDARY, "改变为混合战利品", {}, "", function()
        ...
        STAT_SET_INT("H4LOOT_PAINT_SCOPED", 127)
        Notify("次要目标现在是混合型\n\n当使用这种方法时，百分比和最终付款是随机的!")
    end)

    menu.action(CAYO_SECONDARY, "现金", {}, "", function()
    ...
    menu.action(CAYO_SECONDARY, "大麻", {}, "", function()
    ...
    menu.action(CAYO_SECONDARY, "可卡因", {}, "", function()
        STAT_SET_INT("H4LOOT_CASH_I", 0)
        STAT_SET_INT("H4LOOT_CASH_C", 0)
        STAT_SET_INT("H4LOOT_CASH_V", 0)
        STAT_SET_INT("H4LOOT_WEED_I", 0)
    ...
    menu.action(CAYO_SECONDARY, "黄金", {}, "", function()
        STAT_SET_INT("H4LOOT_CASH_I", 0)
        STAT_SET_INT("H4LOOT_CASH_C", 0)
        STAT_SET_INT("H4LOOT_CASH_V", 0)
        STAT_SET_INT("H4LOOT_WEED_I", 0)
    ...
    local CAYO_COMPOUND = menu.list(CAYO_SECONDARY, "别墅内战利品", {}, "", function(); end)

        menu.action(CAYO_COMPOUND, "改为混合战利品", {}, "", function()
        ...
        menu.action(CAYO_COMPOUND, "现金", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0xFFFFFFF)
            STAT_SET_INT("H4LOOT_CASH_V", 90000)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_WEED_V", 0)
        ...
        menu.action(CAYO_COMPOUND, "大麻", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_CASH_V", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0xFFFFFFF)
        ...
        menu.action(CAYO_COMPOUND, "可卡因", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_CASH_V", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_WEED_V", 0)
        ...
        menu.action(CAYO_COMPOUND, "黄金", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_CASH_V", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_WEED_V", 0)
        ...
        menu.action(CAYO_COMPOUND, "油画", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_CASH_V", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_WEED_V", 0)
