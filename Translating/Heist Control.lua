...
--- Cayo Secondary
    ...
    menu.action(CAYO_SECONDARY, "改变为混合战利品", {}, "", function()
        ...
        STAT_SET_INT("H4LOOT_PAINT_SCOPED", 127)
        Notify("次要目标现在是混合\n\n当使用这个方法，百分比和最终支付是随机的!  !")
    end)

    menu.action(CAYO_SECONDARY, "战利品为现金", {}, "", function()
        ...
        STAT_SET_INT("H4LOOT_PAINT_SCOPED", 127)
        Notify("次要目标是现金,\n\n使用这种方法时，百分比和最终付款是随机的")
    end)

    menu.action(CAYO_SECONDARY, "战利品是大麻", {}, "", function()
    ...
    menu.action(CAYO_SECONDARY, "战利品是可卡因", {}, "", function()
        STAT_SET_INT("H4LOOT_CASH_I", 0)
        STAT_SET_INT("H4LOOT_CASH_C", 0)
        STAT_SET_INT("H4LOOT_CASH_V", 0)
        STAT_SET_INT("H4LOOT_WEED_I", 0)
    ...
    menu.action(CAYO_SECONDARY, "战利品是黄金", {}, "", function()
        STAT_SET_INT("H4LOOT_CASH_I", 0)
        STAT_SET_INT("H4LOOT_CASH_C", 0)
        STAT_SET_INT("H4LOOT_CASH_V", 0)
        STAT_SET_INT("H4LOOT_WEED_I", 0)
    ...
    menu.action(CAYO_SECONDARY, "移除所有", {}, "", function()
        STAT_SET_INT("H4LOOT_CASH_I", 0)
        STAT_SET_INT("H4LOOT_CASH_C", 0)
        STAT_SET_INT("H4LOOT_CASH_V", 0)
        STAT_SET_INT("H4LOOT_WEED_I", 0)
    ...
    local CAYO_COMPOUND = menu.list(CAYO_SECONDARY, "更改战利品", {}, "", function(); end)

        menu.action(CAYO_COMPOUND, "改为别墅战利品", {}, "", function()
        ...
        menu.action(CAYO_COMPOUND, "改为现金", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0xFFFFFFF)
            STAT_SET_INT("H4LOOT_CASH_V", 90000)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_WEED_V", 0)
        ...
        menu.action(CAYO_COMPOUND, "改为大麻", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_CASH_V", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0xFFFFFFF)
        ...
        menu.action(CAYO_COMPOUND, "改为可卡因", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_CASH_V", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_WEED_V", 0)
        ...
        menu.action(CAYO_COMPOUND, "改为黄金", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_CASH_V", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_WEED_V", 0)
        ...
        menu.action(CAYO_COMPOUND, "改为油画", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_CASH_V", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_WEED_V", 0)
        ...
        menu.action(CAYO_COMPOUND, "移除油画", {}, "", function()
            STAT_SET_INT("H4LOOT_PAINT", 0)
            STAT_SET_INT("H4LOOT_PAINT_V", 0)
            STAT_SET_INT("H4LOOT_PAINT_SCOPED", 0)
            Notify("油画已被移除!")
        ...
        menu.action(CAYO_COMPOUND, "移除所有", {}, "", function()
            STAT_SET_INT("H4LOOT_CASH_C", 0)
            STAT_SET_INT("H4LOOT_WEED_C", 0)
            STAT_SET_INT("H4LOOT_COKE_C", 0)
            STAT_SET_INT("H4LOOT_GOLD_C", 0)
...
--- Cayo Weapon
    ...
    menu.action(CAYO_WEAPONS, "选择侵略者", {}, "", function()
        STAT_SET_INT("H4CNF_WEAPONS", 1)
        Notify("侵略者\n\n突击霰弹枪+冲锋手枪\n砍刀+手榴弹")
    end)

    menu.action(CAYO_WEAPONS, "选择阴谋者", {}, "", function()
        STAT_SET_INT("H4CNF_WEAPONS", 2)
        Notify("阴谋者\n\n军用步枪 + 指虎 + 粘弹", "武器装备")
    end)

    menu.action(CAYO_WEAPONS, "选择神枪手", {}, "", function()
        STAT_SET_INT("H4CNF_WEAPONS", 3)
        Notify("神枪手\n\n狙击步枪 + 刀具 + 汽油瓶", "武器装备"")
    end)

    menu.action(CAYO_WEAPONS, "选择破坏者", {}, "", function()
...
--- Cayo Equipment
    ...
    menu.action(CAYO_EQUIPM, "S刷在机场", {}, "", function()
    ...
    menu.action(CAYO_EQUIPM, "刷在码头", {}, "", function()
